...
/** Real adapter for the MetaMask browser extension / mobile in-app browser. */
export class MetaMaskAdapter implements IWalletAdapter {
  public readonly id: WalletProviderId = 'metamask';
  ...
  private detectRawProvider(): InjectedEip1193Provider | undefined {
    ...
    if (ethereum.providers?.length) {
      return ethereum.providers.find((p) => p.isMetaMask && !p.isRabby);
    }
